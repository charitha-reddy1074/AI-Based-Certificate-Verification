...
import { db } from "./db";
import { users, certificates, verifierUnlocks, type User, type InsertUser, type Certificate, type InsertCertificate, type VerifierUnlock } from "@shared/schema";
...
async function initStorage() {
  ...
  const useDatabase = process.env.DATABASE_URL && process.env.NODE_ENV === "production" && db;
