    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-display font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Welcome Back</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Button 
            type="submit" 
            className="w-full h-11 text-lg font-medium bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-background transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed"
      ...
      <footer className="border-t border-border bg-background/50 py-6">
        <div className="max-w-7xl mx-auto px-4 text-center text-sm text-muted-foreground">
          <p>© 2024 AI Based Decentralised Academic Credential Verification System. Built by Example University | <Link href="/" className="text-primary hover:text-secondary transition">Back to Home</Link></p>
        </div>
      </footer>
    </div>
  );
