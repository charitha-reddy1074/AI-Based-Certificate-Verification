        ...
        <div className="bg-gradient-to-r from-blue-500/10 to-blue-500/5 border border-blue-500/30 rounded-xl p-6 flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="mt-3 grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <p className="text-muted-foreground">Roll Number</p>
                <p className="font-mono text-foreground font-bold">{blockchainCertificate.rollNumber}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="space-y-2 text-sm">
              <div>
                <p className="text-muted-foreground">Branch</p>
                <p className="font-semibold text-foreground">{blockchainCertificate.branch}</p>
              </div>
              <div>
                <p className="text-muted-foreground">Period</p>
                <p className="font-semibold text-foreground">
                  {blockchainCertificate.joiningYear} - {blockchainCertificate.passingYear}
                </p>
              </div>
              <div>
                <p className="text-muted-foreground">University</p>
                <p className="font-semibold text-foreground">{blockchainCertificate.university}</p>
              </div>
            </div>
          </motion.div>
        </div>
