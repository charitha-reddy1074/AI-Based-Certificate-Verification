    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 py-12 flex items-center justify-center px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-display font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Create Account</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Button 
            className="w-full h-12 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-background font-medium transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed" 
