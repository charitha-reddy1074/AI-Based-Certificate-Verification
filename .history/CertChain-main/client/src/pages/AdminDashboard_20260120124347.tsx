...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Header */}
      <header className="bg-gradient-to-r from-primary to-secondary text-foreground p-6 shadow-lg sticky top-0 z-40">
              ...
              <form onSubmit={handleSubmit(onIssue)} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input defaultValue="Malla Reddy University" {...register("university", { required: true })} className="bg-input border-input text-foreground placeholder:text-muted-foreground" />
                  </div>
                  <div className="space-y-2">
