      ...
      <main className="flex-1">
        <section className="relative overflow-hidden py-24 sm:py-32">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-display font-black text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-primary mb-6 leading-tight">
                Secure Academic <br />
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>Built by Malla Reddy University</li>
              </ul>
            </div>
          </div>
          <div className="border-t border-border pt-8 text-center">
            <p className="text-muted-foreground">© 2024 AI Based Decentralised Academic Credential Verification System. All rights reserved. | Built with by Malla Reddy University</p>
          </div>
        </div>
      </footer>
    </div>
